...
export function HowItWorks() {
  return (
    ...
    >
      {/* Background glow */}
      <div className="pointer-events-none absolute -top-24 -left-24 h-[600px] w-[600px] rounded-full bg-purple-300/20 blur-[140px]" />
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {index !== steps.length - 1 && (
                <div className="absolute left-12 top-28 h-full w-px bg-gradient-to-b from-purple-300/70 to-transparent" />
              )}

              {/* Step number */}
              <div className="relative z-10 flex h-24 w-24 flex-shrink-0 items-center justify-center rounded-3xl bg-gradient-to-br from-purple-500 to-blue-600 shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:shadow-purple-500/40">
              ...
              {/* Content card */}
              <div className="relative flex-1 rounded-3xl border border-white/40 bg-white/70 p-8 shadow-[0_20px_50px_rgba(140,120,255,0.18)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_30px_70px_rgba(140,120,255,0.25)]">
                <div className="mb-4 flex items-start justify-between gap-4">
                  <h3 className="text-xl font-semibold text-gray-900 transition-colors duration-300 group-hover:text-purple-700 sm:text-2xl">
                    {step.title}
                  </h3>

                  <CheckCircle2 className="h-7 w-7 flex-shrink-0 text-purple-500 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                </div>
                ...
                <div className="mt-4 flex items-center text-purple-600 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
